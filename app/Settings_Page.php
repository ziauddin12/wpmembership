...
class Settings_Page {
  ...
  function __construct( $args, $statusApi ) {

    $this->config = $args;
    $this->settings_api = new \WeDevs_Settings_API();
    $this->settings_fields = array();
    $this->apiStaus = $statusApi;
  ...
  public function create_wpsac_settings_page() {
    ...
    if( $this->apiStaus !=='Active'){
        echo  '<div class="notice notice-error"><p> Invalid license. Response: ' . $this->apiStaus .'</p></div>';
      } else {
          echo  '<div class="notice notice-success is-dismissible"><p> API Status: ' . $this->apiStaus .'</p></div>';
       }
